...
__Code__ = python
__Github__ = https://github.com/Spider-Team0
__Date__ = 21 - 3 - 2020
__Team__ = Spider 
__License__ = GNU General Public License V.3

(c) debby anggraini 2020
...
def banner():
	print (RR+'\n         Telegram: Spider-Team0'+WW+' 1.1.1')
	print (W+'  ------------------------------')
	print (P+'  88  88    db    .dP"Y8 88  88 ')
	print (P+'  88  88   dPYb   `Ybo." 88  88 ')
	print (P+'  888888  dP__Yb  o.`Y8b 888888')
	print (P+'  88  88 dP""""Yb 8bodP  88  88')
	print (W+'  ------------------------------')
	print ("           \033[2;2m Spider "+sys.argv[0]+" --Rania\n"+W)

def info():

	print (Y+"\n 0{======================"+W+" INFO "+Y+"=======================}0")
	print (Y+" |"+B+" ["+R+"="+B+"] "+W+"Name     "+C+":"+W+" Hash"+Y+"                               |")
	...
	print (Y+" |"+B+" ["+R+"="+B+"] "+W+"Telegram    "+C+":"+W+" Spider_Team0"+Y+"                   |")
	print (Y+" |"+B+" ["+R+"="+B+"] "+W+"Github   "+C+":"+W+" https://github.com/Team-Spider0"+Y+"           |")
	print (Y+" |"+B+" ["+R+"="+B+"] "+W+"Date     "+C+":"+W+" 23 - 02 - 2018"+Y+"                       |")
	print (Y+" |"+B+" ["+R+"="+B+"] "+W+"Team     "+C+":"+W+" Spider-Team0"+Y+"                   |")
	print (Y+" 0{===================================================}0\n")
